            ...
            <div class="card">
                ...
                <div class="row p-3">
                    ...
                    <div class="row pb-5 p-5 main">
                        <div class="col-md-6 kiri">
                        <p class="font-weight-bold"><?php echo aa('Kepada Yth ',$data[0]->nama,'');?></p>
                            <p class="mb-1"><?php echo $data[0]->alamat;?><br /><?php echo $data[0]->nohp;?></p>
                        </div>

                        <div class="col-md-6 kanan">
                            <div class="text-right">
                        <?php
                            if (!empty($data[0]->sertifikat_gambarcincin)){
                                ?>
                                <img src="<?php echo $data[0]->sertifikat_gambarcincin;?>" align="right" class="img-thumbnail" width="200px;" alt="cincin kawin" />
                                <?php
                            }
                            ?></div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Cincin Pertama (Cincin Pria)<br /><?php echo $data[0]->bahanpria()->first()['title'];?></td>
                                        <td><?php echo aa('',$data[0]->sertifikat_beratpria,'gr');?></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Cincin Wanita<br /><?php echo $data[0]->bahanwanita()->first()['title'];?></td>
                                        <td><?php echo aa('',$data[0]->sertifikat_beratwanita,'gr');?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <?php 
                                        echo rupiah($data[0]->hargabarang);
                                        ?>
                                        </td>
                                    </tr>
                                </tbody>
