                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td colspan="2">Ongkos Pembuatan</td>
                                    ...
                                    <tr>
                                        <td colspan="3" align="right">Biaya</td>
                                        <td >
                                        <?php
                                            $pria = $data->sertifikat_beratpria * $data->sertifikat_hargapria;
                                            $wanita = $data->sertifikat_beratwanita * $data->sertifikat_hargawanita;
                                            $total = $pria + $wanita + $data->ongkos_bikin;
                                            if (!empty($data->sertifikat_berlian) && !empty($data->sertifikat_harga_berlian)){
