                            ...
                            <table class="table table-bordered">
                                ...
                                <?php
                                    ...
                                    if ($data->yang_premium == 'P'){
                                       ...
                                       $total = $data->sertifikat_beratpria * $data->sertifikat_hargapria + $data->biaya_produksi_pria;
                                    }
                                    elseif ($data->yang_premium == 'W'){
                                       ...
                                       <?php
                                        ...
                                        $total = $data->sertifikat_beratwanita * $data->sertifikat_hargawanita + $data->biaya_produksi_wanita;
