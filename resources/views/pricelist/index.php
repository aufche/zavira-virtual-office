   ...
   foreach ($pair as $key => $value){
        ...
        ?>
            <div class="col-md-6 pl-5">
                <h2 class="p-0 mb-3 display-4"><span class="bg-warning text-dark p-2 shadow" style="font-weight:700"><?php echo $key;?></span></h2>
                ...
                <div class="clearfix mt-3">
                    ...
                    <span class="float-right"> <?php echo rupiah($total);?></span>
                </div>
    ...
    <div class="row mt-5 text-center">
        <div class="col">Free Exclusive Ring Box</div>
        <div class="col">Free Engrave Name</div>
        <div class="col">Sertifikat Logam</div>
