...
.head{
  ...
  <div class=" text-center mb-5" style="font-size:40px;"><br />
            <h1 class="display-3" style="font-weight:700"><span class="bg-dark text-light p-2"><?php echo 'Pricelist Cincin Single'; ?></span></h1>
            <p class="display-5"><span class="bg-warning p-2">Material Emas Putih Premium</span></p>
    </div>
    

    <span class="p-3 bg-light shadow font-weight-bold border border-secondary"><i class="far fa-gem"></i> Emas Putih Premium</span>
    <table class="table mb-5 table-bordered">
        <tr>
			<td rowspan="2" class="align-middle bg-light text-dark">No</td>
            <td rowspan="2" class="align-middle bg-light text-dark">Kadar</td>
			<td rowspan="2" class="align-middle bg-light text-dark">Harga @gram</td>
			<td colspan="4" class="text-center bg-light text-dark">HARGA CINCIN JADI<br />(sudah termasuk ongkos pembuatan <?php echo rupiah(($ongkos_bikin->isi/2));?>)</td>
		</tr>
		<tr>
