                        ...
                        <div class="card-header bg-dark text-white">Detail Perhiasan</div>
                                <div class="card-body">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        <label for="validationDefault03">Kode Perhiasan</label>
                                        <input type="text" name="kode"  class="form-control" v-model="ukuran_pria" placeholder="P001" >
                                        </div>
                                        
                                        <div class="col-md-2 mb-3">
                                        <label for="validationDefault03">Jenis Perhiasan</label>
                                        <input type="text" name="jenis_perhiasan"  class="form-control" v-model="ukuran_pria" placeholder="Gelang, Kalung, Anting atau Liontin" >
                                        </div>
                                        ...
                                        <label for="gambar">Detail Finising</label>
                                          <textarea class="form-control" rows="4" name="finising_perhiasan" v-model="finising_pria"></textarea>
                                        </div>
