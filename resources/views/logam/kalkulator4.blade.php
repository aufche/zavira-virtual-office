@include('layouts.kalkulatorheader')
  ...
  <form method="post" action="<?php echo route('generate.backend');?>">
  ...
  <div class="container mt-3">
    ...
    <div class="row g-2">
        ...
        <div class="col-md-3 col-xs-2">
            <div class="form-floating">
            <select class="form-select" name="pot_pria" id="floatingSelectGrid" aria-label="Floating label select example">
            <option value="0">Dikurangi</option>
                <option value="1">Ditambah</option>
            </select>
            <label for="floatingSelectGrid">Pot. Harga</label>
            </div>
        </div>
    ...
    <div class="row g-2">
        ...
        <div class="col-md-3 col-xs-2">
            <div class="form-floating">
            <select class="form-select" name="pot_wanita" id="floatingSelectGrid" aria-label="Floating label select example">
                <option value="0">Dikurangi</option>
                <option value="1">Ditambah</option>
            </select>
            <label for="floatingSelectGrid">Pot. Harga</label>
